          ...
          <div className="space-y-4">
            ...
            <div className="bg-secondary/30 rounded-2xl p-4 border border-border/30">
              ...
              <div className="flex flex-col gap-1 overflow-x-auto pb-2">
                {/* Gavetas intercaladas com vãos - começa com gaveta, termina com vão */}
              ...
              <p className="text-xs text-muted-foreground mt-2">
                {quantidadeGavetas} gaveta{quantidadeGavetas > 1 ? 's' : ''} + {quantidadeGavetas} vãos de 3cm = {quantidadeGavetas * 3}cm de espaçamento
              </p>
            </div>
